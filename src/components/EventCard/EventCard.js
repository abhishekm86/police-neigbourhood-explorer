...
class EventCard extends Component{
	...
	getLocationIcon( width, height ){
		return (
			<svg width = {(!!width)?width:'auto'} height = {(!!height)?height:'auto'} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 141.73 141.73">
	...
	getCalendarIcon( width, height ){
		return (
			<svg width = {(!!width)?width:'auto'} height = {(!!height)?height:'auto'} class="icon-UqsLt" viewBox="0 0 16 16" version="1.1">
